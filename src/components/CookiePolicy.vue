<template>
  <div>
    <h1>Cookie Policy for Claro Altstätten</h1>

    <p>
      This is the Cookie Policy for Claro Altstätten, accessible from
      https://www.altstaetten-claro.ch/
    </p>
