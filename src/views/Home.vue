<template>
  <main class="flex flex-col flex-grow">
    ...
    />
    <div class="px-4 py-4 mx-4 border rounded">
...
export default {
  ...
  components: {},
  metaInfo: {
    title: "Claro Altstätten",
    meta: [
      {
        name: "description",
        content: "Homepage von Claro Altstätten, ihr Laden für Fairtrade",
      },
    ],
  },
};
